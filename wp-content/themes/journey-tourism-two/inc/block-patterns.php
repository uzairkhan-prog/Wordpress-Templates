 ...
 * @return void
 */
function journeytourism_register_block_patterns()
{
    $block_pattern_categories = array(
        'journey-tourism-two' => array('label' => esc_html__('journey-tourism-two', 'journey-tourism-two')),
        'pages'  => array('label' => esc_html__('Pages', 'journey-tourism-two')),
    );
     ...
     * }
     */
    $block_pattern_categories = apply_filters('journeytourism_block_pattern_categories', $block_pattern_categories);
        ...
        if (is_file($file_path) && pathinfo($file_path, PATHINFO_EXTENSION) == 'php') {
            ...
            if ($file !== 'pricing-table-2.php') {
                ...
                if (!empty($pattern_content)) {
                    ...
                    $pattern_name = 'journey-tourism-two-pattern-' . sanitize_title($pattern_title); // Generate a unique name for the pattern
...
add_action('init', 'journeytourism_register_block_patterns', 9);
