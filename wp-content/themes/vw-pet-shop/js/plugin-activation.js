jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_pet_shop_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-pet-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-pet-shop-plugin-install');
                button.addClass('button-primary vw-pet-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-pet-shop-recommended-plugins .vw-pet-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-pet-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-pet-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-pet-shop-recommended-plugins').css('display','none');
    });
