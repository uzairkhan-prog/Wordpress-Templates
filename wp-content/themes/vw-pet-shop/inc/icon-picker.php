        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-pet-shop' ); ?>">
                </div>
...
function vw_pet_shop_customizer_script() {
    ...
    wp_enqueue_script( 'vw-pet-shop-customizer-script', esc_url(get_template_directory_uri()).'/js/customizer-scripts.js', array("jquery"),'', true  );
}
