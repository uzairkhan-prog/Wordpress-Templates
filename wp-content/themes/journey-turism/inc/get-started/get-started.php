...
function journeytourism_getting_started() {
	add_theme_page( esc_html__('JourneyTourism Theme', 'journey-turism'), esc_html__('JourneyTourism Theme', 'journey-turism'), 'edit_theme_options', 'journeytourism-guide-page', 'journeytourism_test_guide');
}
...
<div class="wrapper-info">
	<div class="intro row">
		<div class="col-lg-6">
			<h1 class="theme-title"><?php esc_html_e( 'JourneyTourism WordPress Theme', 'journey-turism' ); ?> - <small> <?php echo esc_html($theme['Version']);?> </small></h1>
		
			<p><b><?php esc_html_e('JourneyTourism Theme ','journey-turism'); ?></b><?php esc_html_e('is now installed and ready to use. We hope the following information will help and you enjoy using it!', 'journey-turism'); ?></p>
			<a class="bg-color-2 " href="<?php echo esc_url( JourneyTourism_PRO_DEMO ); ?>" target="_blank"><?php esc_html_e('Preview Theme', 'journey-turism'); ?></a>
			<a class="bg-color " href="<?php echo esc_url( JourneyTourism_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Upgrade to Pro', 'journey-turism'); ?></a>
		</div>
		<div class="col-lg-6">
	...
	<div class="features">
		...
		<h4><?php esc_html_e('Unlock Premium Features', 'journey-turism'); ?></h4>
				...
				<a class="bg-color-3" href="<?php echo esc_url( JourneyTourism_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Upgrade Now', 'journey-turism'); ?></a>
		</div>
		<div class="col">
