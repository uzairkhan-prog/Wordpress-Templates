...
if ($settings['slides_list']) :
	$cozy_slide_id = 'cozySlideTwo';
	$slide_per_view = $settings['cozy_carousel_post_per_view']; ?>
	<div id="<?php echo esc_attr($cozy_slide_id) . '"' . ' ' . 'data-slidePerView="' . esc_attr($slide_per_view) . '" ' . 'data-carouselColumnGap="' . esc_attr($settings['cozy_carousel_column_gap']); ?>" class=" cozy-slides content-block swiper">
