<?php
/**
 * Title: Logo Showcase section five with column animation
 * Description: This is logo showcase section with column, animation
 * Slug: cozy-block-patterns/logo-showcase-five
...
<!-- wp:group {"metadata":{"name":"<?php esc_html_e( 'Logo Showcase', 'cozy-addons' ); ?>"},"align":"full","style":{"color":{"background":"#fafafa"},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-group alignfull has-background" style="background-color:#fafafa;margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"80px","bottom":"80px","left":"16px","right":"16px"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
