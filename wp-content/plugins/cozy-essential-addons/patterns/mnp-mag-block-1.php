...
/**
 * Title: PRO: Magazine Block 1
 * Slug: cozy-essential-addons/mnp-mag-block-1
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:20px;padding-top:0px;padding-right:16px;padding-bottom:0px;padding-left:16px"><!-- wp:group {"style":{"spacing":{"padding":{"top":"16px","bottom":"16px","left":"16px","right":"16px"}}},"backgroundColor":"box-background","layout":{"type":"constrained","contentSize":"100%"}} -->
    <div class="wp-block-group has-box-background-background-color has-background" style="padding-top:16px;padding-right:16px;padding-bottom:16px;padding-left:16px"><!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
        ...
        <div class="wp-block-columns has-box-background-background-color has-background" style="margin-top:16px;margin-bottom:0;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:column {"style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"24px"}},"border":{"right":{"color":"var:preset|color|border-color","width":"1px"}}},"backgroundColor":"box-background"} -->
            <div class="wp-block-column has-box-background-background-color has-background" style="border-right-color:var(--wp--preset--color--border-color);border-right-width:1px;padding-top:0px;padding-right:24px;padding-bottom:0px;padding-left:0px"><!-- wp:query {"queryId":27,"query":{"perPage":"1","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->
