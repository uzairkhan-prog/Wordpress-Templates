...
/**
 * Title: About us with Large Image
 * Slug: cozy-essential-addons/ha-aboutus-large-image
 * Categories: ha-patterns-pro
 */
$ct_patterns_images = array(
    COZY_ESSENTIAL_ADDONS_URL . 'admin/images/hello-agency-assets/aboutus_large_img.jpg',
);
?>
...
<div class="wp-block-group hello-agency-animate" style="padding-top:120px;padding-right:var(--wp--preset--spacing--50);padding-bottom:120px;padding-left:var(--wp--preset--spacing--50)"><!-- wp:cover {"url":"<?php echo esc_url($ct_patterns_images[0]) ?>","id":487,"dimRatio":0,"minHeight":560,"layout":{"type":"constrained"}} -->
    <div class="wp-block-cover" style="min-height:560px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-487" alt="" src="<?php echo esc_url($ct_patterns_images[0]) ?>" data-object-fit="cover" />
    ...
    <!-- wp:columns {"verticalAlignment":"top","style":{"spacing":{"blockGap":{"left":"80px"},"padding":{"top":"60px"}}}} -->
    <div class="wp-block-columns are-vertically-aligned-top" style="padding-top:60px"><!-- wp:column {"verticalAlignment":"top","width":"40%"} -->
        <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40%"><!-- wp:group {"style":{"spacing":{"padding":{"bottom":"1rem"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
        ...
        <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:60%"><!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}}} -->
            ...
            <div class="wp-block-group" style="padding-top:30px"><!-- wp:buttons {"align":"full","layout":{"type":"flex","justifyContent":"left","flexWrap":"nowrap"},"style":{"spacing":{"margin":{"top":"0"}}}} -->
                ...
                <ul class="is-style-list-style-no-bullet has-heading-color-color has-text-color has-medium-font-size" style="padding-right:0;padding-left:0"><!-- wp:list-item {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"medium"} -->
                    <li class="has-medium-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html('+1 (012) 345-6789', 'cozy-essential-addons') ?></li>
                    <!-- /wp:list-item -->
                </ul>
                <!-- /wp:list -->
            </div>
