...
/**
 * Title: Header layout with topbar
 * Slug: cozy-essential-addons/ha-header-with-topbar
...
<div class="wp-block-group" style="padding-top:20px;padding-right:0;padding-bottom:20px;padding-left:0"><!-- wp:group {"style":{"border":{"top":{"width":"0px","style":"none"},"bottom":{"color":"var:preset|color|neutral-color","width":"1px"},"right":{},"left":{}},"spacing":{"padding":{"top":"15px","bottom":"15px","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
    <div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-bottom-color:var(--wp--preset--color--neutral-color);border-bottom-width:1px;padding-top:15px;padding-right:var(--wp--preset--spacing--50);padding-bottom:15px;padding-left:var(--wp--preset--spacing--50)"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
        <div class="wp-block-group"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group"><!-- wp:list {"style":{"spacing":{"padding":{"right":"0","left":"0"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"heading-color","className":"is-style-list-style-no-bullet"} -->
                <ul class="is-style-list-style-no-bullet has-heading-color-color has-text-color" style="padding-right:0;padding-left:0;font-style:normal;font-weight:600"><!-- wp:list-item -->
                    <li><?php echo esc_html('+1 (012) 345-6789', 'cozy-essential-addons') ?></li>
                    <!-- /wp:list-item -->
                </ul>
                <!-- /wp:list -->
                ...
                <ul class="is-style-list-style-no-bullet has-heading-color-color has-text-color" style="padding-right:0;padding-left:0;font-style:normal;font-weight:600"><!-- wp:list-item -->
                    <li><?php echo esc_html('email@example.com', 'cozy-essential-addons') ?></li>
                    <!-- /wp:list-item -->
                </ul>
                <!-- /wp:list -->
            </div>
    ...
    <!-- wp:group {"style":{"border":{"top":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"}},"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
    <div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-bottom-style:none;border-bottom-width:0px;padding-right:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
        <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"top":"20px","bottom":"20px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
            ...
            <div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-bottom-style:none;border-bottom-width:0px;padding-top:15px;padding-bottom:15px"><!-- wp:navigation {"ref":35,"layout":{"type":"flex","justifyContent":"left"}} /-->

                <!-- wp:buttons -->
                <div class="wp-block-buttons"><!-- wp:button {"textColor":"heading-color","style":{"border":{"width":"1px","color":"#ffffff","radius":"0px"},"color":{"background":"#ffffff00"},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"18px"}},"className":"is-style-button-hover-primary-bgcolor"} -->
                    <div class="wp-block-button has-custom-font-size is-style-button-hover-primary-bgcolor" style="font-size:18px;font-style:normal;font-weight:500"><a class="wp-block-button__link has-heading-color-color has-text-color has-background has-border-color wp-element-button" style="border-color:#ffffff;border-width:1px;border-radius:0px;background-color:#ffffff00"><?php echo esc_html('Request Demo', 'cozy-essential-addons') ?></a></div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->
            </div>
